...
/// convenient type alias for MySql/MaraDB event store
pub type MySqlEventStore<C, E, A> = EventStore<C, E, A, Storage>;

/// convenient type alias for MySql/MaraDB query store
